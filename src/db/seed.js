...
async function seedOnce() {
  ...
  try {
    ...
    await conn.query(
      'INSERT INTO employees (id, employee_code, company_id, office_id, geofence_key, role, full_name, password_hash, email, fcm_token, employee_type, supervisor_id, is_supervisor) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
      [
        employeeId,
